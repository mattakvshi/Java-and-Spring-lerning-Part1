...
public class WordWriter {
    ...
    String createTask5(int var){
        ...
        fileDocx.addPicture("src\\main\\resources\\image\\график задание 5.png", 309, 196);
    ...
    String createTask6(int var){
        ...
        if(var == 1){
            ...
            fileDocx.addPicture("src\\main\\resources\\image\\график задание 6А.png", 385, 268);
        }
        else if(var == 2){
            fileDocx.addTextBreak(questionStr);
            fileDocx.addPicture("src\\main\\resources\\image\\график задание 6Б.png", 385, 268);
        }
        else if(var == 3){
            fileDocx.addTextBreak(questionStr);
            fileDocx.addPicture("src\\main\\resources\\image\\график задание 6В.png", 385, 268);
        }
        else if(var == 4){
            ...
            fileDocx.addPicture("src\\main\\resources\\image\\график задание 6Г.png", 385, 268);
        }
