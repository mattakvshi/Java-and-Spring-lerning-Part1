...
public class ThemesWRC  implements TxtManager{
    ...
    public void writeInTxt(String userTheme) {
        try(FileWriter writer = new FileWriter("src\\main\\resources\\configuration\\ThemesConfig.txt", false))
        {
    ...
    public String readFromTxt() throws IOException {
        ...
        try(FileReader fileReader = new FileReader("src\\main\\resources\\configuration\\ThemesConfig.txt")) {
