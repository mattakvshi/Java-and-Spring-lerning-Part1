...
public class FontFamilyWRC implements TxtManager{
    ...
    public void writeInTxt(String fontFamily) {
        try(FileWriter writer = new FileWriter("src\\main\\resources\\configuration\\FontFamilyConfig.txt", false))
        {
    ...
    public String readFromTxt() throws IOException {
        ...
        try (FileReader fileReader = new FileReader("src\\main\\resources\\configuration\\FontFamilyConfig.txt")) {
