...
public class PathWRC implements TxtManager{
    ...
    public void writeInTxt(String userFilePath) {
        try(FileWriter writer = new FileWriter("src\\main\\resources\\configuration\\PathConfig.txt", false))
        {
    ...
    public String readFromTxt() throws IOException {
        ...
        try(FileReader fileReader = new FileReader("src\\main\\resources\\configuration\\PathConfig.txt")) {
