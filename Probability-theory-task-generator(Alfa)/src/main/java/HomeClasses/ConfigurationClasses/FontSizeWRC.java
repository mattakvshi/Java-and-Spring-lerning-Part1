...
public class FontSizeWRC implements TxtManager{
    ...
    public void writeInTxt(String fontSize) {
        try(FileWriter writer = new FileWriter("src\\main\\resources\\configuration\\FontSizeConfig.txt", false))
        {
    ...
    public String readFromTxt() throws IOException {
        ...
        try (FileReader fileReader = new FileReader("src\\main\\resources\\configuration\\FontSizeConfig.txt")) {
