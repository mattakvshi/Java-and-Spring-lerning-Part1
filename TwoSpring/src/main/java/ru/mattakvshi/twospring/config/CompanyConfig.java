package ru.mattakvshi.twospring.config;
...
import ru.mattakvshi.twospring.company.employer.Employer;
import ru.mattakvshi.twospring.company.employer.ITRole;

@Configuration
@ComponentScan("ru.mattakvshi.twospring.company")
